...
namespace program1
{
    ...
    public class Order
    {
        ...
        public string CustPhone { set; get; }   //客户电话
        ...
        public Order(string costumer)
        {
            ...
            string serialNo = GetRandomNumber(1, 999).ToString("000");
            this.OrderNo = date + serialNo;
            this.Customer = costumer;
        }
        public Order(string orderNum,string costumer,string Phone)
        {
    ...
    public class OrderService
    {
        ...
        public void UpdateCustomer(string orderId, string newCustomer)
        {
